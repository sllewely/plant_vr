...
public class CloseHandTrigger : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        leftSide.transform.rotation = Quaternion.Euler(0, closeLevel, 0);
        rightSide.transform.rotation = Quaternion.Euler(0, -closeLevel, 0);
        //Quaternion rotation = Quaternion.identity;
        //rotation.eulerAngles = new Vector3(0, closeLevel, 0);
